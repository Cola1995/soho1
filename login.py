...
class CrackGeetest(object):
    def __init__(self):
        self.url = 'https://dev2.bitsdaq.io/login'
        options = webdriver.ChromeOptions()
        options.add_argument("--start-maximized")
        self.browser = webdriver.Chrome(options=options)
        self.wait = WebDriverWait(self.browser, 10)
        self.username="hero@qq.com"
        self.pwd ="qwerdf886."
    ...
    def open(self):
        ...
        time.sleep(2)
        print("填写密码")
        self.browser.find_element_by_xpath('//*[@id="password"]').send_keys(self.pwd)
        print("点击登录按钮")
        self.browser.find_element_by_xpath('//*[@id="captchaEmail"]/button').click()
    ...
    def get_geetest_button(self):
        ...
        button = self.wait.until(
            EC.element_to_be_clickable((By.CSS_SELECTOR, '#captchaEmail > button'))
        )
        return button
